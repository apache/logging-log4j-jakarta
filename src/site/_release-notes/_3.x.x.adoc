...
* Update `org.mockito:mockito-bom` to version `5.7.0` (https://github.com/apache/logging-log4j-jakarta/pull/3[3])
* Update `org.springframework:spring-framework-bom` to version `6.1.0` (https://github.com/apache/logging-log4j-jakarta/pull/4[4])
