...
This project provides various https://jakarta.ee/[Jakarta]-specific https://logging.apache.org/log4j[Log4j] components.

include::_log4j-jakarta-jms.adoc[]

include::_log4j-jakarta-smtp.adoc[]

include::_log4j-jakarta-web.adoc[]
