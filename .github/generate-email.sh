...
# Constants
PROJECT_NAME="Apache Log4j Jakarta"
PROJECT_SITE="https://logging.apache.org/log4j/jakarta"
PROJECT_STAGING_SITE="${PROJECT_SITE/apache.org/staged.apache.org}"
PROJECT_REPO="https://github.com/apache/logging-log4j-jakarta"
PROJECT_DIST_DIR="https://dist.apache.org/repos/dist/dev/logging/log4j-jakarta"
PROJECT_VERSION="$2"
COMMIT_ID="$3"
